...
function scene:show( event )
	...
	elseif event.phase == "did" then
		...
		local function arcade21( event )
  			composer.gotoScene( "scripts.cenas.arcade2-1.menu", {effect = "slideLeft",time = 300} )
  			btn:removeEventListener( "tap", arcade21 )
		end
		local function arcade31( event )
  			composer.gotoScene( "scripts.cenas.arcade3-1.menu", {effect = "slideLeft",time = 300} )
  			btn2:removeEventListener( "tap", arcade31 )
		end
		local function arcade32( event )
  			composer.gotoScene( "scripts.cenas.arcade3-2.menu", {effect = "slideLeft",time = 300} )
  			btn3:removeEventListener( "tap", arcade32 )
		end
		local function arcade41( event )
  			composer.gotoScene( "scripts.cenas.arcade4-1.menu", {effect = "slideLeft",time = 300} )
  			btn4:removeEventListener( "tap", arcade41 )
		end
		local function arcade42( event )
  			composer.gotoScene( "scripts.cenas.arcade4-2.menu", {effect = "slideLeft",time = 300} )
  			btn5:removeEventListener( "tap", arcade42 )
		end
		local function arcade43( event )
  			composer.gotoScene( "scripts.cenas.arcade4-3.menu", {effect = "slideLeft",time = 300} )
  			btn6:removeEventListener( "tap", arcade43 )
		end
		local function back( event )
  			composer.gotoScene( "scripts.cenas.mainmenu", {effect = "slideRight",time = 300} )
  			btn7:removeEventListener( "tap", back )
		end
		...
		function criarMenu (event)
			...
			elseif i == 2 then
				btn2 = Botao.newPlayButton("Arcade 3-1",display.contentHeight / 25 * 7.3)
				btn2:addEventListener( "tap", arcade31 )
				grupoMenu:insert( btn2 )
			elseif i == 3 then
				btn3 = Botao.newPlayButton("Arcade 3-2",display.contentHeight / 25 * 9.6)
				btn3:addEventListener( "tap", arcade32 )
				grupoMenu:insert( btn3 )
			elseif i == 4 then
				btn4 = Botao.newPlayButton("Arcade 4-1",display.contentHeight / 25 * 11.9)
				btn4:addEventListener( "tap", arcade41 )
				grupoMenu:insert( btn4 )
			elseif i == 5 then
				btn5 = Botao.newPlayButton("Arcade 4-2",display.contentHeight / 25 * 14.2)
				btn5:addEventListener( "tap", arcade42 )
				grupoMenu:insert( btn5 )
			elseif i == 6 then
				btn6 = Botao.newPlayButton("Arcade 4-3",display.contentHeight / 25 * 16.5)
				btn6:addEventListener( "tap", arcade43 )
				grupoMenu:insert( btn6 )
			elseif i == 7 then
				btn7 = Botao.newPlayButton("Back",display.contentHeight / 25 * 18.8)
