...
local function createText()
    local memory = display.newText('00 00.00 000',10,0, 'Helvetica', 60);
	--memory:setFillColor(255,53,247)
	memory:setFillColor(0)
    memory.anchrX,memory.anchorY = 0,0
    memory.x, memory.y = display.contentCenterX, display.contentHeight / 2 -200
    function memory:tap ()
